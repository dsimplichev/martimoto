...
function PartsDetails() {
    ...
    const nextPage = () => {
        if (indexOfLastPart < parts.length) setCurrentPage(currentPage + 1);
    };
    ...
    return (
        <div className="parts-details">
            ...
            <div className="pagination">
                ...
                <button onClick={nextPage} disabled={indexOfLastPart >= parts.length} className="pagination-btn">Напред</button>
            </div>
            {selectedPart && (
